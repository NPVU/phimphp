...
<div class="col-xs-10 col-sm-10 col-md-10 col-lg-10">
    <div class="video-player">        
        <video id="video-player" autoplay="true" width="100%" controls poster="{{asset('public/img/themes/video-poster.gif')}}">            
