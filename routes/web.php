...
Route::post('/post-yeu-cau', 'HomeController@postYeuCau');
Route::post('/post-error', 'HomeController@postError');
Route::post('/post-feedback', 'HomeController@postFeedback');
...
Route::post('/load-video-2', 'XemPhimController@loadVideo2');
